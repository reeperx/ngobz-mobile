...
*Event & Equipment Details:* ${message || "General inquiry"}
----------------------------------------
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start text-left">
          ...
          <div className="lg:col-span-6">
            <div className="rounded-3xl border border-border/80 bg-card p-5 sm:p-7 lg:p-8 backdrop-blur-xl shadow-lg space-y-4">
              <div>
              ...
              {contactSubmitted ? (
                <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-700 dark:text-emerald-400 text-center space-y-2.5">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-3.5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-background border-border text-foreground placeholder:text-muted-foreground px-3.5 py-2.5 h-10 text-xs focus-visible:ring-blue-500 rounded-xl"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={3}
                      className="bg-background border-border text-foreground placeholder:text-muted-foreground px-3.5 py-2 text-xs focus-visible:ring-blue-500 resize-none rounded-xl"
                    />
                  </div>
